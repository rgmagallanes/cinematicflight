...
const required = ["PROSPECTING_AGENT_ENDPOINT", "PROSPECTING_AGENT_TOKEN", "PROSPECTING_MISSION_PUBLIC_ID", "PROSPECTING_PROSPECT_PUBLIC_ID", "PROSPECTING_WEBSITE_URL"];
...
const completed = await runManualWebsiteResearch({
  ingest, transport: createPinnedHttpsTransport(), missionPublicId: mission, prospectPublicId: prospect,
  requestedUrl: website, idempotencyKey: researchKey,
});
